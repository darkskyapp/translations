...
module.exports = require("../template")({
  ...
  "until-starting-again": function(condition, a, b) {
    return condition + " até " + strip_prefix(a) + ", recomeça " + b;
  },
  "starting-continuing-until": function(condition, a, b) {
    return condition + " começa esta" + a + ", continua até à" +
           strip_prefix(b);
  },
  "during": "$1 durante $2",
  "for-week": "$1 durante toda a semana",
  "over-weekend": "$1 durante todo o fim de semana",
  "temperatures-peaking": "as temperaturas vão subir até $1 $2",
  "temperatures-rising": "chegaram a um máximo de $1 $2",
  "temperatures-valleying": "as temperaturas vão descer $1 $2",
  "temperatures-falling": "vão descer até um minimo de $1 $2",

...
module.exports = {
  ...
  "next-hour-forecast-status": "previsões para a próxima hora estão $1, devido $2",
  "unavailable": "indisponíveis",
  "temporarily-unavailable": "temporariamente indisponíveis",
  "partially-unavailable": "parcialmente indisponíveis",
  "station-offline": "a todas as estações de radar próximas estarem offline",
  "station-incomplete": "a falhas na cobertura nas estações de radar próximas",
};

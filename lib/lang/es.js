...
module.exports = require("../template")({
  ...
  "mixed-precipitation": "mixed precipitación",
  "possible-very-light-precipitation": "possible light precipitación",
  "very-light-precipitation": "precipitación ligera",
  ...
  "heavy-precipitation": "precipitación fuerte",
  ...
  "later-today-morning": "despues esta mañana",
  "today-afternoon": "esta tarde",
  "later-today-afternoon": "despues esta tarde",
  "today-evening": "esta noche",
  "later-today-evening": "despues esta noche",
  "today-night": "esta noche",
  "later-today-night": "despues esta noche",
  "tomorrow-morning": "mañana en la mañana",
  "tomorrow-afternoon": "tomorrow afternoon",
  "tomorrow-evening": "tomorrow evening",
  "tomorrow-night": "tomorrow night",
  "morning": "en la morning",
  "afternoon": "en la afternoon",
  "evening": "en la noche",
  "night": "sobre la noche",
  "today": "hoy",
  "tomorrow": "mañana",
  "sunday": "el Domingo",
  "monday": "el Lunes",
  ...
  "starting-then-stopping-later": "$1 comenzando en $2, despues parando $3",
  "stopping-then-starting-later": "$1 parando en $2, comenzando otra vez $3 despues",
  "for-day": "$1 durante el dia",
  "starting": "$1 comenzando $2",
  "until": function(condition, period) {
    return condition + " hasta " + strip_prefix(period);
  },
  "until-starting-again": function(condition, a, b) {
    return condition + " hasta " + strip_prefix(a) + ", comenzndo otra vez " + b;
  },

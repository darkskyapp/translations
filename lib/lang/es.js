...
module.exports = require("../template")({
  ...
  "starting-then-stopping-later": "$1 comenzando en $2, despues parando en $3",
  "stopping-then-starting-later": "$1 parando en $2, comenzando de nuevo $3 despues",

...
/* Prefix is included in period. It is more convenient solution for pl */
  return period;
}
...
module.exports = require("../template")({
  ...
  "starting": function(condition, period) {
    return strip_prefix(period) + ' ' + condition ;
  },
  "until": function(condition, period) {
    var lstr = (condition.indexOf("opady") > -1) ? ", ustaną " : ", ustanie ";
    return condition + lstr + strip_prefix(period);
  },
  "until-starting-again": function(condition, a, b) {
    var lstr = (condition.indexOf("opady") > -1) ? ", ustaną " : ", ustanie ";
    return condition + lstr + strip_prefix(a) + ", " + b + " ponownie " + condition;
  },
  "starting-continuing-until": function(condition, a, b) {
    var lstr = (condition.indexOf("opady") > -1) ? "skończą" : "skończy";
    return a + " " + condition + ", " + lstr + " się " + strip_prefix(b);
  },
  "during": "$2 $1",

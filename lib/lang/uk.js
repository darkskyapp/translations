...
module.exports = require("../template")({
  ...
  "next-monday": "в наступний понеділок",
  "next-tuesday": "в наступний вівторок",
  "next-wednesday": "в наступну середу",
  "next-thursday": "в наступний четвер",
  "next-friday": "в наступну п'ятницю",
  "next-saturday": "в наступну суботу",
  "minutes": "$1 хв.",
  "fahrenheit": "$1\u00B0F",
  "celsius": "$1\u00B0C",
  "inches": "$1 in.",

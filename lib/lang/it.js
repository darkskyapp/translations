...
module.exports = require("../template")({
  ...
  "possible-light-rain": "possibilita di pioggia leggera",
  ...
  "possible-light-sleet": "possibilita di nevischio leggero",
  ...
  "later-today-night": "a notte inoltrata",
  ...
  "parenthetical": "$1 ($2)",
  "for-hour": "$1 per ora",
  "starting-in": "$1 a partire da $2",
  "stopping-in": "$1 fino a $2",
  "starting-then-stopping-later": "$1 a partire da $2, arrivando a $3",
  "stopping-then-starting-later": "$1 arrivando a $2, ripartendo da $3",
  "for-day": "$1 al giorno",
  "starting": "$1 cominciando da $2",
  ...
  "starting-continuing-until": function(condition, a, b) {
    return condition + " cominciando da " + a + ", fino a  " +
           strip_prefix(b);
  },
  "during": "$1 $2",
  "for-week": "$1 a settimana",
  "over-weekend": "$1 tutto il week end",
  "temperatures-peaking": "temperatura massima di $1 $2",
  "temperatures-rising": "temperatura in aumento fino a $1 $2",
  "temperatures-valleying": "temperatura minima di $1 $2",
  "temperatures-falling": "temperatura in diminuzione fino a $1 $2",

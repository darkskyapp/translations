...
module.exports = {
  ...
  "unavailable-radar": "Прогнозата за идния час $1 поради $2.",
  "temporarily": "временно не е на разположение",
  "partially": "е частична",
  "station-offline": "липса на информация от всички близки станции",
  "station-spotty": "недостатъчно информация от близки станции",
};

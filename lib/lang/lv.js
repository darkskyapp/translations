...
// "apstākļa vārds": ["akuzatīvs", "datīvs"], - no ... līdz ...
const grammar = {
  "no rīta":           ["rīta", "rītam"],
  ...
  "nākam svētdien":    ["nākamās svētdienas", "nākamai svētdienai"],
  "nākam pirmdien":    ["nākamās pirmdienas", "nākamai pirmdienai"],
  "nākam otrdien":     ["nākamās otrdienas", "nākamai otrdienai"],
  "nākam trešdien":    ["nākamās trešdienas", "nākamai trešdienai"],
  "nākam ceturtdien":  ["nākamās ceturtdienas", "nākamai ceturtdienai"],
  "nākam piektdien":   ["nākamās piektdienas", "nākamai piektdienai"],
  "nākam sestdien":    ["nākamās sestdienas", "nākamai sestdienai"],
};
...
module.exports = {
  ...
  "friday": "piektdien",
  "saturday": "sestdien",
  "next-sunday": "nākam svētdien",
  "next-monday": "nākam pirmdien",
  "next-tuesday": "nākam otrdien",
  "next-wednesday": "nākam trešdien",
  "next-thursday": "nākam ceturtdien",
  "next-friday": "nākam piektdien",
  "next-saturday": "nākam sestdien",
  "minutes": "$1 min.",
  "fahrenheit": "$1\u00B0F",
  "celsius": "$1\u00B0C",
  "inches": "$1 collas",

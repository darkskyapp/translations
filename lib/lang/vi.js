...
module.exports = {
  ...
  "until": function(condition, period) {
    return condition + " tới " + strip_prefix(period);
  },
  "until-starting-again": function(condition, a, b) {
    return condition + " cho đến " + strip_prefix(a) + ", bắt đầu lại " + b;
  },
  ...
  "temperatures-peaking": "nhiệt độ đỉnh điểm $1 $2",
  "temperatures-rising": "nhiệt độ tăng tới $1 $2",
  "temperatures-valleying": "nhiệt độ thấp nhất $1 $2",

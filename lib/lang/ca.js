...
module.exports = require("../template")({
  ...
  "later-today-morning": "després al matí",
  "today-afternoon": "aquesta tarda",
  "later-today-afternoon": "després a la tarda",
  "today-evening": "aquest vespre",
  "later-today-evening": "després al vespre",
  "today-night": "aquesta nit",
  "later-today-night": "després a la nit",
  ...
  "starting-in": "$1 començant a $2",
  "stopping-in": "$1 parant a $2",
  "starting-then-stopping-later": "$1 començant a $2, després parant a $3",
  "stopping-then-starting-later": "$1 parant a $2, començant de nou a $3 després",
  "for-day": "$1 durant el dia",
  "starting": "$1 començant $2",
  "until": function(condition, period) {
    return condition + " fins a " + strip_prefix(period);
  },
  "until-starting-again": function(condition, a, b) {
    return condition + " fins a " + strip_prefix(a) + ", començant a " + b;
  },
  "starting-continuing-until": function(condition, a, b) {
    return condition + " començant a " + a + ", continuant fins a " +
           strip_prefix(b);
  },
  "during": "$1 $2",
  ...
  "temperatures-falling": "temperatures caient a $1 $2",

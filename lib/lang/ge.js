...
module.exports = require("../template")({
  ...
  "through": function(a, b) {
    return join_with_shared_prefix(a, b, " მეშვეობით ");
  },
  "with": "$1, თან $2",
  "range": "$1\u2013$2",
  ...
  "for-hour": "$1 ამ დროსითვის",
  "starting-in": "$1 დაიწყება $2",
  "stopping-in": "$1 შეწყდება $2",
  "starting-then-stopping-later": "$1 დაიწყება $2, შეწყდება $3 მოვიანებით",
  ...
  "until": function(condition, period) {
    return condition + " მანამდე " + strip_prefix(period);
  },

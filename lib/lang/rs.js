...
function time_var(time, pref)
{
  switch(time) {
    ...
    case "četvrt":
      switch(pref){
				...
				case "do":
					time+="ka";
					if(mscope!==undefined){
						if(mscope[2]!==undefined && mscope[3]!==undefined && mscope[2]=="during" && mscope[3]=="through"){
							return time;
						}
					}
					time = pref+"do "+time;
    ...
    case "sred":
      ...
      break;
		case "noć":
			if(mscope[1]=="starting-continuing-until"){
				return "tokom noći";
			}
			switch(pref){
				case "u":
		...
		break;
		case "sutra noć":
			if(mscope[2]=="starting-continuing-until"){
				return "tokom noći";
			}
			switch(pref){
				case "u":
		...
		case "kasnije ovog jutra":
			...
			if(mscope[1]=="until-starting-again"){
...
function getPrefix(a){
	switch(a){
		...
		break;
		case "sutra ujutro":
			if(mscope[1]=="during" && mscope[2]=="and"){
				return " i ";
			}
			return ", ";
		break;
		default:
			if(mscope!==undefined){
				if(mscope[0]=="title" && mscope[1]=="and"){
					return " i ";
				}
			}
			return ", ";
...
module.exports = require("../template")({
  "clear": function(){ mscope = this; return "vedro"; }, 
  ...
  "medium-snow": "sneg",
  "heavy-snow": function(){ mscope = this; return "jak sneg"; },
  "light-wind": function(){ mscope = this; return "vetrovito"; }, 
  "medium-wind": function(){ mscope = this; return "vetrovito"; },
  "heavy-wind": function(){ mscope = this; return "opasno vetrovito"; },
  "low-humidity": function(){ mscope = this; return "suvo"; },
  "high-humidity": function(){ mscope = this; return "vlažno"; },
  "fog": function(){ mscope = this; return "maglovito"; },
  "light-clouds": function(){ mscope = this; return "mestimično oblačno"; },
  "medium-clouds": function(){ mscope = this; return "pretežno oblačno"; }, 
  "heavy-clouds": function(){ mscope = this; return "oblačno"; },
  "today-morning": "ovog jutra",
  "later-today-morning": function(){ mscope = this; return "kasnije ovog jutra"; },
  "today-afternoon": "ovog popodneva",
  "later-today-afternoon": "kasnije ovog popodneva",
  "today-evening": "uveče",
  "later-today-evening": "kasno uveče",
  "today-night": "večeras",
  "later-today-night": function(){ mscope = this; return "kasnije noć"; },
  "tomorrow-morning": function(){ mscope = this; return "sutra ujutro"; },
  "tomorrow-afternoon": "sutra popodne",
  "tomorrow-evening": "sutra uveče",
  "tomorrow-night": function(){ mscope = this; return "sutra noć"; },
  "morning": "ujutro",
  "afternoon": "popodne",
  "evening": "uveče",
  "night": function(){ mscope = this; return "noć"; },  
  "today": "danas",
  "tomorrow": "sutra",
  "monday": function(){ mscope = this; return "ponedelj"; },
  "tuesday": function(){ mscope = this; return "utor"; },
  "wednesday": function(){ mscope = this; return "sred"; },
  "thursday": function(){ mscope = this; return "četvrt"; },
  "friday": function(){ mscope = this; return "pet"; },
  "saturday": function(){ mscope = this; return "subot"; },
	"sunday": function(){ mscope = this; return "nedelj"; },
  "minutes": "$1 minuta",
  "fahrenheit": "$1\u00B0F",
  "celsius": "$1\u00B0C",
  "inches": "$1 inča",
  ...
  "through": function(a, b) {
		return join_with_shared_prefix(time_var(a, "od"), time_var(b, "do"), " do ");
  },
  "with": "$1, sa $2",
  "range": "$1\u2013$2",
  "parenthetical": "$1 ($2)",

...
module.exports = {
  "clear": "soilleir",
  "no-precipitation": "chan eil sileadh ann",
  ...
  "very-light-sleet": "flin glè aotram",
  "possible-light-sleet": "tha cothrom ann gum bi flin aotrom",
  "light-sleet": "flin aotram",
  "medium-sleet": "flin",
  "heavy-sleet": "flin trom",
  "possible-very-light-snow": "fras sneachda",
  "very-light-snow": "frasan sneachda",
  "possible-light-snow": "tha cothrom ann gum bi frasan sneachda",
  ...
  "medium-wind": "gaothach",
  "heavy-wind": "gaoth chunnartach",
  "low-humidity": "tioram",
  "high-humidity": "tais",
  "fog": "ceòthach",
  "light-clouds": "sgotham aotrom",
  ...
  "until": function(condition, period) {
    return condition + " gu " + strip_prefix(period);
  },
  "until-starting-again": function(condition, a, b) {
    return condition + " gu " + strip_prefix(a) + ", a' tòiseachadh a-rithist " + b;
  },
  "starting-continuing-until": function(condition, a, b) {
    return condition + " a' tòiseachadh " + a + ", a' dol gu " + strip_prefix(b);
  },
  "during": "$1 $2",
  "for-week": "$1 fad na seachdain",
  "over-weekend": "$1 thairis air an deireadh-sheachdain",
  "temperatures-peaking": "teòthachd àrd suas gu $1 $2",
  "temperatures-rising": "teòthachd àrd a' fàs gu $1 $2",
  "temperatures-valleying": "teòthachd àrd sìoss gu $1 $2",
  "temperatures-falling": "teòthachd àrd a' tuiteam gu $1 $2",

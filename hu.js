...
module.exports = require("../template")({
  ...
  "starting-then-stopping-later": "$1 $2 múlva, $3-ig",
  "stopping-then-starting-later": "$1 $2 múlva véget ér, de $3 elteltével újra várható",
  "for-day": "$1 egész nap",
  "starting": "$1 lesz $2",
  "until": function(condition, period) {
    return condition + strip_prefix(period)+ "ig ";
  },
  "until-starting-again": function(condition, a, b) {
    return condition + strip_prefix(a) + "ig " + ", majd "+ b +" ismét" ;
  },
  "starting-continuing-until": function(condition, a, b) {
    return condition + " kezdődik " + a + ", " + strip_prefix(b) + "ig folytatódik";
  },
  "during": "$1 $2",
